...
CoreGui:SetCore("SendNotification", {
    Title = "启动成功",
    Text = "您好"..game.Players.LocalPlayer.Name.."，欢迎使用苗脚本",
    Duration = 5,
})
...
local Window = OrionLib:MakeWindow({Name = "苗脚本", HidePremium = false, SaveConfig = true,IntroText = "苗脚本", ConfigFolder = "好想超人，或被炒😋"})
OrionLib:MakeNotification({
  Name = "欢迎使用苗脚本,作者QQ群:729273818",
...
Tab:AddParagraph("你好"..game.Players.LocalPlayer.Name..",欢迎使用苗脚本","脚本仅供娱乐")
...
Tab:AddParagraph("光影均无法关闭","只可以替换与叠加")
Tab:AddButton({
  Name = "光影（滤镜）",
  Default = false,
  Callback = function()
